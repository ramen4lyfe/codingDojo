...
class Recipe:
    ...
    def __init__(self,db_data):
        ...
        self.datemade = db_data['datemade']
    ...
    def validate_recipe(recipe):
        ...
        if len(recipe['name']) < 3:
            is_valid = False
            flash("Name must be at least 3 characteres","recipe")
        if len(recipe['instructions']) < 3:
            is_valid = False
            flash("Instructions must be at least 3 characteres","recipe")
        if len(recipe['description']) < 3:
            is_valid = False
            flash("Description must be at least 3 characteres","recipe")
