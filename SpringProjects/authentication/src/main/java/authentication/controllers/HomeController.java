//Combining both controller into one. Ideally each route should have it's own controller file
...
public class HomeController {
	...
	public String index(Model model) {
		...
		// bringing in modelAttribute from the register form section in the JSP file
